        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo site_url() . "mobilrental/edit/" . $mobil["id_mobil"]; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
            ...
            <div class="col-md-6 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo site_url() . "mobilrental/edit_gambar/" . $mobil["id_mobil"]; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    ...
                                    <input name="foto" type="file" id="input-file-now" class="form-control" data-max-file-size="20M" required />
                                </div>
                            </div>
                            <div class="ln_solid"></div>
                            <div class="form-group">
