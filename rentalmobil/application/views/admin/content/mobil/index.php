    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                ...
                <!-- <br>
                <a href="<?php echo site_url('mobil/add'); ?>" class="btn btn-primary m-b-0-25 waves-effect waves-light"><i class="ti-write"></i>&nbsp;Tambah Data</a> -->
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <?php echo form_open('mobil/filter_kategori', array("id" => "mainform", "class" => "btn"));  ?>
                        <select class="form-control select2" name="filter_kategori" onchange="this.form.submit()">
                            <option value="">Pilih Sewa</option>
                            <?php foreach ($kategori as $data) : ?>
                                <option value="<?= $data['id'] ?>" <?php if ($filter_kategori == $data['id']) : ?>selected<?php endif ?>><?= $data['nama'] ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?php echo form_close(); ?>

                        <?php echo form_open_multipart('mobil/search', array("class" => "form-horizontal btn"));  ?>
                                        ...
                                        <div class="image view view-first">
                                            ...
                                            <div class="mask">
                                                ...
                                                <div class="tools tools-bottom">
                                                    <a href="<?php echo base_url(); ?>mobil/detail/<?= $key['id_mobil'] ?>"><i class="fa fa-link"></i></a>
                                                    <!-- <a href="<?php echo base_url(); ?>mobil/edit/<?= $key['id_mobil'] ?>"><i class="fa fa-pencil"></i></a>
...
<script>
    function myFunction(recertid) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    window.location = "<?php echo site_url('mobil/remove/'); ?>" + recertid;
                } else {
                    //return false;
                    swal({
                        title: "",
