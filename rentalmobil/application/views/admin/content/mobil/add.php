        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo site_url() . "mobil/add"; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">

                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3 ">Sewa</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <select name="rental" class="form-control form-control-sm" required="">
